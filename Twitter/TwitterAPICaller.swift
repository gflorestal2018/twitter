...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "HCcUajnLzFqqvTyWXvoGremId", consumerSecret: "Ghw6nvOgPgYzu9fhvE0gAi1hJmWupHOcHphoEExOzWkXxQcw1s")
    var loginSuccess: (() -> ())?
